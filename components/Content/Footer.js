        ...
        <>
            <div className={"bg-footer bg-cover bg-no-repeat bg-center "}>
                ...
                <div className={"container mx-auto pt-5 pb-20"}>
                    ...
                    <div className={"flex justify-center items-center content-center "}>
                        <a href="https://www.instagram.com/igmerwina/" target="_blank" className={"mr-3 flex"} rel="noreferrer">
                            <Image src={Instagram} width={25} height={25}/>
                            <p className={"text-white"}>&nbsp;@igmerwina </p>
                        </a>
                        <a href="https://www.instagram.com/putuuindira/" target={"_blank"} className={"flex"} rel="noreferrer">
                            <Image src={Instagram} width={25} height={25}/>
                            <p className={"text-white"}>&nbsp;@putuuindira </p>
                        </a>
                    </div>
                    <br/>
                </div>
